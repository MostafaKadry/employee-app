    ...
    <div className="space-y-6">
          ...
          <div className="space-y-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-900">{department.companyName}</p>
              </div>
            </div>
            <div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 border">
          ...
          <div className="bg-blue-50 rounded-lg p-6">
            <div className="flex items-center">
              ...
              <div>
                <p className="text-2xl font-bold text-blue-700">{departmentEmployees.length}</p>
      ...
      <div className="bg-white rounded-lg shadow-sm border">
        <div className="p-6 border-b border-gray-200">
          <h2 className="text-lg font-semibold text-gray-900">Department Employees</h2>
        </div>
        <div className="p-6">
          {departmentEmployees.length > 0 ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="mt-1 text-sm text-gray-500">This department doesn't have any employees yet.</p>
              <div className="mt-6">
                <Link
